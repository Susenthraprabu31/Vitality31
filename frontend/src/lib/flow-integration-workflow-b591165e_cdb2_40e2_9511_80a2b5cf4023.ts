...
const executeFlowChain_flow_page_load_1770835954478_1771079854765 = async (initialData: any = {}): Promise<FlowResult> => {
  ...
  flowResults._executionId = `flow_page_load_1770835954478_1771079854765_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
  ...
  //  flowResults.stepCounter = 0; // Initialize step counter for sequential step tracking
    ...
    flowResults.originalChainData = {"id":"flow_page-load-1770835954478_1771079854765","nodes":[{"id":"page-load-1770835954478","nodeType":"page-load","config":{"pageId":"page-17702812000504656","pageUrl":"/orientation-calls","loadType":"full"}},{"id":"openaiAgentSDKNode-1770835965761","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4","tools":[],"userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770835987812","url":"https://newgooglecalendar-smu6q7.simplita.ai/mcp","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","enableMemory":false,"handoff_mode":"transfer_control","instructions":"On each page load, automatically fetch the list of orientation calls scheduled for the current day from the connected Google Calendar MCP tool.\nLogic\nGet the current UTC timestamp at page load.\nConvert the UTC timestamp to IST (UTC+05:30) to determine today’s IST date.\nCompute the UTC equivalents for the start and end of that IST day:\ntimeMin = 00:00:00 IST → previous day 18:30:00 UTC\ntimeMax = 23:59:59 IST → current day 18:29:59 UTC\nUse these values to call the Google Calendar MCP tool with the following configuration:\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\ntimeMin: start of IST day in UTC\ntimeMax: end of IST day in UTC\nResponse Handling\nThe MCP tool will return event data.\nConvert each event’s start and end times from UTC → IST.\nFor each event, extract:\ntitle: event title\ndate: event date in IST (YYYY-MM-DD)\ntime: formatted time range in IST (e.g., “10:00 AM - 11:00 AM”)\nOutput Format\nIf events are found, return the result only in this JSON array format:\n[\n  {\n    \"title\": \"Orientation Call - Batch A\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"10:00 AM - 11:00 AM\"\n  },\n  {\n    \"title\": \"Orientation Call - Batch B\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"12:30 PM - 1:30 PM\"\n  }\n]\nIf no events are found, return an empty array:\n[]\n:cog: Important Instruction\nReturn the final output strictly as a valid JSON array — no markdown, no text explanation, no extra wrapping object.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"structured-output-parser-1770836012620","nodeType":"structured-output-parser","config":{"inputSource":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770835965761\")}}"}},{"id":"script-event-1771005380506","nodeType":"script-event","config":{"pageId":"page-17702812000504656","scriptId":"ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","elementId":"component-1771002248957-6083","eventType":"onLoad","scriptKey":"page-17702812000504656::component-1771002248957-6083::onLoad::ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","scriptName":"Orientationcall","actionValue":"select","componentId":"component-1771002248957-6083","inputVariables":[{"name":"innerHTML","type":"string","source":"element","description":"Element property: innerHTML"}],"outputVariables":[{"name":"selectedCall","type":"object","source":"custom","description":"Output variable: selectedCall"},{"name":"action","type":"object","source":"custom","description":"Output variable: action"},{"name":"callCount","type":"object","source":"custom","description":"Output variable: callCount"},{"name":"getInputData('response')","type":"object","source":"custom","description":"Variable: getInputData('response')"},{"name":"status","type":"object","source":"custom","description":"Variable: status"},{"name":"'response'","type":"object","source":"custom","description":"Variable: 'response'"}],"inputVariableMappings":{"innerHTML":"{{dataFlow.getByNodeId(\"structured-output-parser-1770836012620\")}}"}}}],"edges":[{"source":"page-load-1770835954478","target":"openaiAgentSDKNode-1770835965761"},{"source":"openaiAgentSDKNode-1770835965761","target":"structured-output-parser-1770836012620"},{"source":"structured-output-parser-1770836012620","target":"script-event-1771005380506"}],"chainType":"linear","dataFlow":[],"startNode":{"id":"page-load-1770835954478","nodeType":"page-load","config":{"pageId":"page-17702812000504656","pageUrl":"/orientation-calls","loadType":"full"}},"endNode":{"id":"script-event-1771005380506","nodeType":"script-event","config":{"pageId":"page-17702812000504656","scriptId":"ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","elementId":"component-1771002248957-6083","eventType":"onLoad","scriptKey":"page-17702812000504656::component-1771002248957-6083::onLoad::ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","scriptName":"Orientationcall","actionValue":"select","componentId":"component-1771002248957-6083","inputVariables":[{"name":"innerHTML","type":"string","source":"element","description":"Element property: innerHTML"}],"outputVariables":[{"name":"selectedCall","type":"object","source":"custom","description":"Output variable: selectedCall"},{"name":"action","type":"object","source":"custom","description":"Output variable: action"},{"name":"callCount","type":"object","source":"custom","description":"Output variable: callCount"},{"name":"getInputData('response')","type":"object","source":"custom","description":"Variable: getInputData('response')"},{"name":"status","type":"object","source":"custom","description":"Variable: status"},{"name":"'response'","type":"object","source":"custom","description":"Variable: 'response'"}],"inputVariableMappings":{"innerHTML":"{{dataFlow.getByNodeId(\"structured-output-parser-1770836012620\")}}"}}}};
    ...
    if (typeof window !== 'undefined') {
      ...
      const sanitizedNodes = [{"id":"page-load-1770835954478","nodeType":"page-load","config":{"pageId":"page-17702812000504656","pageUrl":"/orientation-calls","loadType":"full"}},{"id":"openaiAgentSDKNode-1770835965761","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4","tools":[],"userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770835987812","url":"https://newgooglecalendar-smu6q7.simplita.ai/mcp","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","enableMemory":false,"handoff_mode":"transfer_control","instructions":"On each page load, automatically fetch the list of orientation calls scheduled for the current day from the connected Google Calendar MCP tool.\nLogic\nGet the current UTC timestamp at page load.\nConvert the UTC timestamp to IST (UTC+05:30) to determine today’s IST date.\nCompute the UTC equivalents for the start and end of that IST day:\ntimeMin = 00:00:00 IST → previous day 18:30:00 UTC\ntimeMax = 23:59:59 IST → current day 18:29:59 UTC\nUse these values to call the Google Calendar MCP tool with the following configuration:\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\ntimeMin: start of IST day in UTC\ntimeMax: end of IST day in UTC\nResponse Handling\nThe MCP tool will return event data.\nConvert each event’s start and end times from UTC → IST.\nFor each event, extract:\ntitle: event title\ndate: event date in IST (YYYY-MM-DD)\ntime: formatted time range in IST (e.g., “10:00 AM - 11:00 AM”)\nOutput Format\nIf events are found, return the result only in this JSON array format:\n[\n  {\n    \"title\": \"Orientation Call - Batch A\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"10:00 AM - 11:00 AM\"\n  },\n  {\n    \"title\": \"Orientation Call - Batch B\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"12:30 PM - 1:30 PM\"\n  }\n]\nIf no events are found, return an empty array:\n[]\n:cog: Important Instruction\nReturn the final output strictly as a valid JSON array — no markdown, no text explanation, no extra wrapping object.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"structured-output-parser-1770836012620","nodeType":"structured-output-parser","config":{"inputSource":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770835965761\")}}"}},{"id":"script-event-1771005380506","nodeType":"script-event","config":{"pageId":"page-17702812000504656","scriptId":"ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","elementId":"component-1771002248957-6083","eventType":"onLoad","scriptKey":"page-17702812000504656::component-1771002248957-6083::onLoad::ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","scriptName":"Orientationcall","actionValue":"select","componentId":"component-1771002248957-6083","inputVariables":[{"name":"innerHTML","type":"string","source":"element","description":"Element property: innerHTML"}],"outputVariables":[{"name":"selectedCall","type":"object","source":"custom","description":"Output variable: selectedCall"},{"name":"action","type":"object","source":"custom","description":"Output variable: action"},{"name":"callCount","type":"object","source":"custom","description":"Output variable: callCount"},{"name":"getInputData('response')","type":"object","source":"custom","description":"Variable: getInputData('response')"},{"name":"status","type":"object","source":"custom","description":"Variable: status"},{"name":"'response'","type":"object","source":"custom","description":"Variable: 'response'"}],"inputVariableMappings":{"innerHTML":"{{dataFlow.getByNodeId(\"structured-output-parser-1770836012620\")}}"}}}];
      
      (window as any).__currentWorkflowNodes = sanitizedNodes;
      (window as any).__flowChainMetadata = {
        chainId: 'flow_page-load-1770835954478_1771079854765',
    ...
    const normalizedInput_page_load_1770835954478 = {};

    step1Result = {
      ...normalizedInput_page_load_1770835954478,
      pageId: 'current-page',
      nodeId: 'page-load-1770835954478',
      trigger: 'page-load',
      timestamp: new Date().toISOString(),
      config: {"pageId":"page-17702812000504656","pageUrl":"/orientation-calls","loadType":"full"}
    };
    ...
    flowResults.nodeResults['page-load-1770835954478'] = {
      nodeId: 'page-load-1770835954478',
      nodeType: 'page-load',
      stepNumber: 1,
      displayName: 'pageLoadResult_page_load_1770835954478',
      data: step1Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    if (!flowResults['pageLoadResult_page_load_1770835954478'] || typeof flowResults['pageLoadResult_page_load_1770835954478'] === 'undefined') {
      flowResults['pageLoadResult_page_load_1770835954478'] = step1Result;
    }
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.__executedNodes && window.__executedNodes.has('openaiAgentSDKNode-1770835965761')) {
        console.log('⏭Skipping node (already executed via handoff):', 'openaiAgentSDKNode-1770835965761');
        
        // Get the result from dataFlow if available
        const existingResult = dataFlow.getByNodeId('openaiAgentSDKNode-1770835965761');
        if (existingResult) {
        ...
        if (typeof window !== 'undefined' && window.__executedNodes) {
          window.__executedNodes.delete('openaiAgentSDKNode-1770835965761');
        }
      } else {
      let aiInput = '';
      ...
      if (!aiInput || aiInput.trim() === '') {
        ...
        if (false && 'simple' !== 'none' && typeof window !== 'undefined') {
          try {
            const agentId = 'agent-1771079854768';
            const userId = 'user-1771079854768';
      ...
      const response = await fetch(apiUrl, {
        ...
        body: JSON.stringify({
         ...
         user_prompt: ``,
          ...
          model: 'gpt-4',
          instructions: `On each page load, automatically fetch the list of orientation calls scheduled for the current day from the connected Google Calendar MCP tool.
Logic
Get the current UTC timestamp at page load.
Convert the UTC timestamp to IST (UTC+05:30) to determine today’s IST date.
Compute the UTC equivalents for the start and end of that IST day:
...
[]
:cog: Important Instruction
Return the final output strictly as a valid JSON array — no markdown, no text explanation, no extra wrapping object.`,
          temperature: 0.7,
          max_tokens: 1000,
          ...
          mcp_servers: [{"id":"custom_mcp_1770835987812","url":"https://newgooglecalendar-smu6q7.simplita.ai/mcp","name":"calendar","enabled":true,"description":"Custom MCP Server"}],
      ...
      if (false && !result.handoff && typeof window !== 'undefined') {
        try {
          ...
          const outgoingEdges = workflowEdges.filter((e: any) => e.source === 'openaiAgentSDKNode-1770835965761');
      ...
      if (false && 'simple' !== 'none' && typeof window !== 'undefined') {
        try {
          const agentId = 'agent-1771079854768';
          const userId = 'user-1771079854768';
          const sessionId = 'session-1771079854768';
          const memoryStorageType = 'simple';
      ...
      flowResults.nodeResults['openaiAgentSDKNode-1770835965761'] = {
        nodeId: 'openaiAgentSDKNode-1770835965761',
      ...
      flowErrors.push('OpenAI Agent SDK error in node ' + "openaiAgentSDKNode-1770835965761" + ': ' + (error instanceof Error ? error.message : String(error)));
    }
    ...
    flowResults.nodeResults['openaiAgentSDKNode-1770835965761'] = {
      ...
      nodeType: 'openaiAgentSDKNode',
      stepNumber: 2,
      displayName: 'openaiSDKResult_openaiAgentSDKNode_1770835965761',
      data: step2Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    // Store in specialized collection using dynamic variable name
    flowResults.aiResponses['openaiSDKResult_openaiAgentSDKNode_1770835965761'] = step2Result;
    
    // Store at top-level for direct access (CRITICAL for HTTP nodes)
    // CRITICAL FIX: Don't overwrite if the processor already set a formatted result
    // This is especially important for Bolna AI which stores formattedResult before polling
    if (!flowResults['openaiSDKResult_openaiAgentSDKNode_1770835965761'] || typeof flowResults['openaiSDKResult_openaiAgentSDKNode_1770835965761'] === 'undefined') {
      flowResults['openaiSDKResult_openaiAgentSDKNode_1770835965761'] = step2Result;
    }
  ...
  // Structured Output Parser Node: structured-output-parser-1770836012620
  console.log('🔧 Processing Structured Output Parser Node: structured-output-parser-1770836012620');
  
  // Declare step result variable for flow chain compatibility
  step3Result;
  ...
  const cleanJsonContent = (text, mode, attempt) => {
    let cleaned = text.trim();
    
    // First, check if the text already contains JSON
    const hasJsonBraces = cleaned.includes('{') && cleaned.includes('}');
    
    if (hasJsonBraces) {
      // Text contains JSON - extract it
      console.log('🔍 Structured Parser: Text contains JSON, extracting...');
      ...
      const lastBracket = cleaned.lastIndexOf(']');
       ...
       // Determine if this is an array or object and extract accordingly
      const isArray = firstBracket !== -1 && (firstBrace === -1 || firstBracket < firstBrace);
      
      if (isArray && firstBracket !== -1 && lastBracket !== -1 && lastBracket > firstBracket) {
        // Extract array content including brackets
        cleaned = cleaned.substring(firstBracket, lastBracket + 1);
        console.log('🔧 Extracted JSON array:', cleaned.substring(0, 100) + '...');
      } else if (firstBrace !== -1 && lastBrace !== -1 && lastBrace > firstBrace) {
        // Extract object content including braces
        cleaned = cleaned.substring(firstBrace, lastBrace + 1);
        console.log('🔧 Extracted JSON object:', cleaned.substring(0, 100) + '...');
      }
      
      if (mode === 'aggressive' || attempt > 1) {
     // Only apply this if we don't already have a valid JSON structure
        if (!cleaned.match(/^\s*[\[{][\s\S]*[\]}]\s*$/)) {
          // For arrays: ensure we keep the closing bracket
          if (cleaned.includes('[') && !cleaned.trim().endsWith(']')) {
            // Find the last complete object and add closing bracket
            const lastBraceIndex = cleaned.lastIndexOf('}');
            if (lastBraceIndex !== -1) {
              cleaned = cleaned.substring(0, lastBraceIndex + 1) + ']';
            }
          }
          // For objects: ensure we keep the closing brace  
          else if (cleaned.includes('{') && !cleaned.trim().endsWith('}')) {
            const lastBraceIndex = cleaned.lastIndexOf('}');
            if (lastBraceIndex !== -1) {
              cleaned = cleaned.substring(0, lastBraceIndex + 1);
            }
      ...
      // Plain text - convert to JSON based on predefined schema or smart extraction
      console.log('🔍 Structured Parser: Plain text detected, converting to JSON...');
      
      if (mode === 'aggressive' || attempt > 2) {
        // Attempt to create structured JSON from plain text
        const extractedData = {};
        ...
        const phoneMatch = cleaned.match(/[\+]?[1-9]?[\-\s\(\)]?[\d\s\-\(\)]{10,}/);
        if (phoneMatch) extractedData.phone = phoneMatch[0].replace(/[\s\-\(\)]/g, '');
        
        // Extract names (assuming "My name is [Name]" or "I'm [Name]")
        const nameMatch = cleaned.match(/(?:my name is|i'm|i am)\s+([a-z]+(?:\s+[a-z]+)*)/i);
        if (nameMatch) extractedData.name = nameMatch[1];
        
        // Extract company names
        const companyMatch = cleaned.match(/(?:at|work at|works at|employed by)\s+([a-z0-9\s&\.,]+?)(?:\s*\.|\s*,|\s*!|$)/i);
        if (companyMatch) extractedData.company = companyMatch[1].trim();
        
        // Extract addresses
        const addressMatch = cleaned.match(/\d+\s+[a-z0-9\s,\.]+,\s*[a-z\s]+,\s*[a-z]{2}\s*\d{5}/i);
        if (addressMatch) extractedData.address = addressMatch[0];
        
        // If we extracted any data, use it; otherwise, store as raw text
        if (Object.keys(extractedData).length > 0) {
          extractedData.originalText = cleaned;
          cleaned = JSON.stringify(extractedData);
        } else {
          // Fallback: wrap in a simple structure
          cleaned = JSON.stringify({ 
            text: cleaned,
            extracted: false,
            message: "Plain text converted to JSON"
          });
        }
      } else {
        // Simple conversion: wrap text in JSON structure
        cleaned = JSON.stringify({ 
          content: cleaned,
          type: "text",
          converted: true
    ...
    // Final cleanup for extracted/converted JSON
    if (mode === 'standard' || attempt > 1) {
    ...
    const startsCorrectly = cleaned.trim().startsWith('[') || cleaned.trim().startsWith('{');
    const endsCorrectly = cleaned.trim().endsWith(']') || cleaned.trim().endsWith('}');
    
    console.log(`🧹 Structured Parser: Cleaned content (attempt ${attempt}): ${cleaned.substring(0, 200)}...`);
    return cleaned;
  };
  
  // Helper function to validate against schema
  const validateAgainstSchema = (data, schema, fallbackMode) => {
    try {
      ...
      if (schema.required && Array.isArray(schema.required)) {
        ...
        if (missing.length > 0) {
          if (fallbackMode === 'strict') {
            return { valid: false, errors: [`Missing required fields: ${missing.join(', ')}`], result: data };
          } else if (fallbackMode === 'partial') {
            // Auto-fill missing fields
            missing.forEach(field => {
              const propDef = schema.properties?.[field];
              if (propDef?.type === 'string') data[field] = '';
              else if (propDef?.type === 'number') data[field] = 0;
              else if (propDef?.type === 'boolean') data[field] = false;
              else if (propDef?.type === 'array') data[field] = [];
              else if (propDef?.type === 'object') data[field] = {};
      ...
      return { valid: true, errors: [], result: data };
    } catch (error) {
      return { valid: false, errors: [error.message], result: data };
    }
  };
  ...
  try {
    ...
    let inputData = null;
    const inputSourceStr = `{{dataFlow.getByNodeId("openaiAgentSDKNode-1770835965761")}}`;
    
    // Process the input source template at runtime
    ...
    try {
      if (inputSourceStr.includes('{{') && inputSourceStr.includes('}}')) {
        console.log('🔧 Structured Parser: Processing input source template:', inputSourceStr);
        inputData = TemplateExpressionEngine.processTemplate(inputSourceStr, templateContext);
      } else if (inputSourceStr.includes('dataFlow.')) {
        console.log('🔧 Structured Parser: Evaluating dataFlow expression:', inputSourceStr);
        inputData = TemplateExpressionEngine.evaluate(inputSourceStr, templateContext, { allowFunctions: true });
      } else {
        // Static input
        inputData = inputSourceStr;
      }
    } catch (templateError) {
      console.warn('⚠️ Structured Parser: Input source processing failed, using fallback:', templateError);
      inputData = flowResults.currentResult;
    }
    
    console.log('🔍 Structured Parser: Raw input data type:', typeof inputData);
    console.log('🔍 Structured Parser: Raw input preview:', 
      typeof inputData === 'string' ? inputData.substring(0, 200) + '...' : inputData);
    ...
    if (typeof inputData === 'string') {
      ...
      // Try common AI response properties
      textContent = inputData.text || 
                   ...
                   inputData.choices?.[0]?.text ||
                   // Gemini format
                   inputData.candidates?.[0]?.content?.parts?.[0]?.text ||
                   // Generic AI response
                   inputData.generated_text ||
                   JSON.stringify(inputData);
    } else {
      textContent = String(inputData || '');
    }
    
    console.log('📝 Structured Parser: Extracted text content length:', textContent.length);
    console.log('📝 Structured Parser: Text preview:', textContent.substring(0, 300) + '...');
    
    // Get the JSON schema to validate against
    const targetSchema = ``;
    let parsedSchema = null;
    
    try {
      if (targetSchema) {
        parsedSchema = JSON.parse(targetSchema);
        console.log('✅ Structured Parser: Schema parsed successfully:', Object.keys(parsedSchema));
      }
    } catch (schemaError) {
      console.warn('⚠️ Structured Parser: Invalid JSON schema:', schemaError);
    }
    
    // Parse the structured output with multiple attempts
    let parsedOutput = null;
    let parseErrors = [];
    let finalAttemptSuccess = false;
    
    for (let attempt = 1; attempt <= 3; attempt++) {
      console.log(`🔄 Structured Parser: Parse attempt ${attempt}/3`);
      
      try {
        const cleanedContent = cleanJsonContent(textContent, 'aggressive', attempt);
        console.log(`🧹 Attempt ${attempt}: Cleaned content length:`, cleanedContent.length);
        ...
        if (parsedSchema) {
          const validation = validateAgainstSchema(parsed, parsedSchema, 'partial');
          if (validation.valid || 'partial' !== 'strict') {
            parsedOutput = validation.result;
            finalAttemptSuccess = true;
            console.log(`✅ Attempt ${attempt}: Successfully parsed and validated`);
            break;
          } else {
            parseErrors.push(`Attempt ${attempt}: Schema validation failed - ${validation.errors.join(', ')}`);
          }
        } else {
          // No schema validation required
          parsedOutput = parsed;
          finalAttemptSuccess = true;
          console.log(`✅ Attempt ${attempt}: Successfully parsed (no schema validation)`);
          break;
        }
      } catch (parseError) {
        const errorMsg = `Attempt ${attempt}: ${parseError.message}`;
        parseErrors.push(errorMsg);
        console.warn(`❌ ${errorMsg}`);
      }
    }
    
    // Create the result object - return only the parsed data for clean output
    parsedData = finalAttemptSuccess ? parsedOutput : {
      error: "Parsing failed after 3 attempts",
    ...
    // Store the clean result in multiple accessible locations
    flowResults.aiResponses["parsedData"] = parsedData;
    flowResults.variables["parsedData"] = parsedData;
    flowResults.nodeResults["structured-output-parser-1770836012620"] = {
      data: parsedData,
      displayName: "parsedData",
      nodeType: "structured-output-parser",
      success: finalAttemptSuccess,
      stepNumber: (flowResults.stepCounter || 0) + 1
    };
    
    // Store parsed output directly for easy access (clean JSON only)
    if (finalAttemptSuccess && parsedOutput) {
      flowResults.variables["parsedData"] = parsedData;
      flowResults["parsedData"] = parsedData;
      
      // Store individual fields for template access
      if (typeof parsedData === 'object' && parsedData !== null) {
        Object.entries(parsedData).forEach(([key, value]) => {
          flowResults[`parsed_${key}`] = value;
        });
      }
    }
    ...
    flowResults.previousResult = flowResults.currentResult;
    flowResults.currentResult = parsedData;
    
    // Increment step counter for proper sequencing
    flowResults.stepCounter = (flowResults.stepCounter || 0) + 1;
    
    console.log('✅ Structured Output Parser - Clean JSON result:', parsedData);
    console.log('📊 Available fields:', finalAttemptSuccess && parsedData ? Object.keys(parsedData) : 'No fields available');

    // Assign to step result variable for flow chain compatibility
    step3Result = parsedData;

    if (finalAttemptSuccess) {
      console.log('✅ Structured Output Parser completed successfully');
    } else {
      console.log('⚠️ Structured Output Parser completed with parsing failures');
    }

  } catch (error) {
    console.error('❌ Error in Structured Output Parser Node structured-output-parser-1770836012620:', error);
    
    // Store clean error result
    parsedData = {
      error: error.message || 'Structured output parsing failed',
      success: false,
      parseErrors: ["Fatal error occurred"]
    };

    // 🔧 ENHANCED: Store error result in Data Flow System
    if (!flowResults.aiResponses) flowResults.aiResponses = {};
    if (!flowResults.nodeResults) flowResults.nodeResults = {};
    if (!flowResults.variables) flowResults.variables = {};
    ...
    console.log('🔄 Structured Output Parser Node structured-output-parser-1770836012620 completed with errors');
  }

  // JSON Content Cleaning Helper Function
  function cleanJsonContent(content, cleanupMode, attempt) {
    let cleaned = content;
    
    // Attempt 1: Minimal cleaning
    if (attempt === 1 || cleanupMode === 'minimal') {
      // Just trim whitespace
      cleaned = cleaned.trim();
    }
    
    // Attempt 2: Standard cleaning
    else if (attempt === 2 || cleanupMode === 'standard') {
      ...
      cleaned = cleaned.replace(/^(Here's|Here is|The JSON is:|JSON:|Response:)\s*/i, '');
    ...
    // Attempt 3+: Aggressive cleaning
      ...
      // Remove all markdown
      cleaned = cleaned.replace(/^```[a-zA-Z]*\s*/gi, '');
      cleaned = cleaned.replace(/\s*```$/gi, '');
      cleaned = cleaned.replace(/`([^`]+)`/g, '$1');
      
      // Remove AI response patterns
      cleaned = cleaned.replace(/^(Here's|Here is|The JSON is:|JSON:|Response:|Sure|Certainly).*?[:\n]/i, '');
      cleaned = cleaned.replace(/^[^{]*?(?={)/i, ''); // Remove everything before first {
      cleaned = cleaned.replace(/}[^}]*$/i, '}'); // Remove everything after last }
      
      // Try to extract JSON from anywhere in the text
      const jsonMatches = cleaned.match(/{[^{}]*}/g) || 
                         cleaned.match(/{.*}/s);
      if (jsonMatches && jsonMatches.length > 0) {
        // Use the longest JSON-like string
        cleaned = jsonMatches.reduce((a, b) => a.length > b.length ? a : b);
      }
      
      // Fix common JSON issues
      cleaned = cleaned.replace(/([{,]\s*)([a-zA-Z_][a-zA-Z0-9_]*)\s*:/g, '$1"$2":'); // Add quotes to keys
      cleaned = cleaned.replace(/:\s*([a-zA-Z_][a-zA-Z0-9_\s]*?)\s*([,}])/g, ': "$1"$2'); // Add quotes to string values
  ...
  function validateAgainstSchema(data, schema, fallbackMode) {
    const errors = [];
    let result = data;
    ...
    try {
        ...
        for (const prop of schema.required) {
          if (!(prop in data)) {
            ...
            if (fallbackMode === 'partial') {
              ...
              if (propSchema.type === 'string') result[prop] = '';
              else if (propSchema.type === 'number') result[prop] = 0;
              else if (propSchema.type === 'boolean') result[prop] = false;
              else if (propSchema.type === 'array') result[prop] = [];
              else if (propSchema.type === 'object') result[prop] = {};
              else result[prop] = null;
            }
          }
        }
        ...
        for (const [key, value] of Object.entries(data)) {
          if (schema.properties[key]) {
            ...
            if (expectedType !== actualType) {
              ...
              if (fallbackMode !== 'ignore') {
                // Try to convert the type
                try {
                  if (expectedType === 'string') result[key] = String(value);
                  else if (expectedType === 'number') result[key] = Number(value);
                  else if (expectedType === 'boolean') result[key] = Boolean(value);
                } catch (e) {
      ...
      return {
        valid: false,
        errors: ['Schema validation error: ' + validationError.message],
        result: fallbackMode === 'strict' ? null : data
      };
    }
  }
    ...
    // Store result in enhanced data flow system
    flowResults.nodeResults['structured-output-parser-1770836012620'] = {
      nodeId: 'structured-output-parser-1770836012620',
      nodeType: 'structured-output-parser',
      stepNumber: 3,
      displayName: 'structured-output-parserResult_structured_output_parser_1770836012620',
      data: step3Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    // Store in specialized collection using dynamic variable name
    // No specialized storage for structured-output-parser
    
    // Store at top-level for direct access (CRITICAL for HTTP nodes)
    // CRITICAL FIX: Don't overwrite if the processor already set a formatted result
    // This is especially important for Bolna AI which stores formattedResult before polling
    if (!flowResults['structured-output-parserResult_structured_output_parser_1770836012620'] || typeof flowResults['structured-output-parserResult_structured_output_parser_1770836012620'] === 'undefined') {
      flowResults['structured-output-parserResult_structured_output_parser_1770836012620'] = step3Result;
    }
    ...
    flowResults.previousResult = flowResults.currentResult;
      ...
      const stepErrorMessage = stepError instanceof Error ? stepError.message : String(stepError) || 'Unknown step error';
      console.error('❌ Error in step 3 (structured-output-parser):', stepError);
      flowErrors.push(`Step 3 (structured-output-parser): ${stepErrorMessage}`);
    ...
    const scriptEventPayload_script_event_1771005380506 = initialData || {};
    const scriptContextData_script_event_1771005380506 =
      scriptEventPayload_script_event_1771005380506.scriptContext ||
      scriptEventPayload_script_event_1771005380506.contextData ||
      scriptEventPayload_script_event_1771005380506;

    if (scriptContextData_script_event_1771005380506 && typeof scriptContextData_script_event_1771005380506 === 'object') {
      (flowResults as any).variables = (flowResults as any).variables || {};
      Object.entries(scriptContextData_script_event_1771005380506).forEach(([key, value]) => {
    ...
    const inputVariableMappings_script_event_1771005380506 = {"innerHTML":"{{dataFlow.getByNodeId(\"structured-output-parser-1770836012620\")}}"};
    const resolvedParameters_script_event_1771005380506: Record<string, any> = {};
    ...
    Object.entries(inputVariableMappings_script_event_1771005380506).forEach(([key, mappingValue]) => {
      ...
      if (resolvedValue !== undefined && resolvedValue !== null) {
        ...
        if (Array.isArray(resolvedValue) || (typeof resolvedValue === 'object' && resolvedValue !== null)) {
          resolvedParameters_script_event_1771005380506[key] = resolvedValue;
    ...
    console.log('📦 Resolved parameters:', resolvedParameters_script_event_1771005380506);
    
    const mergedParameters_script_event_1771005380506 = {
      ...(scriptEventPayload_script_event_1771005380506?.parameters || {}),
      ...resolvedParameters_script_event_1771005380506
    };
    
    // Store resolved parameters in flowResults.scriptEventParameters
    if (Object.keys(mergedParameters_script_event_1771005380506).length > 0) {
      (flowResults as any).scriptEventParameters = mergedParameters_script_event_1771005380506;
      console.log('💾 Stored scriptEventParameters in flowResults:', mergedParameters_script_event_1771005380506);
      ...
      if (typeof window !== 'undefined') {
        ...
        if (scriptContext && typeof scriptContext.setData === 'function') {
          ...
          Object.entries(mergedParameters_script_event_1771005380506).forEach(([key, value]) => {
    ...
    step4Result = {
      ...scriptEventPayload_script_event_1771005380506,
      parameters: mergedParameters_script_event_1771005380506,
      scriptId: scriptEventPayload_script_event_1771005380506?.scriptId || scriptEventPayload_script_event_1771005380506?.script_id || 'ef7e1ec7-0f59-42b2-abbb-6e2ea412a884',
      scriptName: scriptEventPayload_script_event_1771005380506?.scriptName,
      trigger: scriptEventPayload_script_event_1771005380506?.trigger || 'script-event',
    ...
    // Store result in enhanced data flow system
    flowResults.nodeResults['script-event-1771005380506'] = {
      nodeId: 'script-event-1771005380506',
      nodeType: 'script-event',
      stepNumber: 4,
      displayName: 'scriptEventResult_script_event_1771005380506',
      data: step4Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    // CRITICAL FIX: Don't overwrite if the processor already set a formatted result
    // This is especially important for Bolna AI which stores formattedResult before polling
    if (!flowResults['scriptEventResult_script_event_1771005380506'] || typeof flowResults['scriptEventResult_script_event_1771005380506'] === 'undefined') {
      flowResults['scriptEventResult_script_event_1771005380506'] = step4Result;
    }
    ...
    if (typeof window !== 'undefined') {
      ...
      if ('flow_page-load-1770835954478_1771079854765'.includes('button')) {
        ...
        buttonNodes.forEach((buttonNode: any) => {
          ...
          if (buttonNode.elementId) {
            (window as any).buttonChainRegistry[buttonNode.elementId] = 'flow_page-load-1770835954478_1771079854765';
            console.log(`🔗 Registered button chain: ${buttonNode.elementId} → flow_page-load-1770835954478_1771079854765`);
          }
        });
      }
      ...
      (window as any).dispatchEvent(new CustomEvent('workflowCompleted', { 
        detail: { flowResults, chainId: 'flow_page-load-1770835954478_1771079854765' } 
      }));
...
if (workflowRegistry && workflowRegistry.allNodes) {
  const workflowNodes = [{"id":"page-load-1770835954478","nodeType":"page-load","config":{"pageId":"page-17702812000504656","pageUrl":"/orientation-calls","loadType":"full"}},{"id":"openaiAgentSDKNode-1770835965761","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4","tools":[],"apiKey":"","userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770835987812","url":"https://newgooglecalendar-smu6q7.simplita.ai/mcp","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","credentialId":"","enableMemory":false,"handoff_mode":"transfer_control","instructions":"On each page load, automatically fetch the list of orientation calls scheduled for the current day from the connected Google Calendar MCP tool.\nLogic\nGet the current UTC timestamp at page load.\nConvert the UTC timestamp to IST (UTC+05:30) to determine today’s IST date.\nCompute the UTC equivalents for the start and end of that IST day:\ntimeMin = 00:00:00 IST → previous day 18:30:00 UTC\ntimeMax = 23:59:59 IST → current day 18:29:59 UTC\nUse these values to call the Google Calendar MCP tool with the following configuration:\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\ntimeMin: start of IST day in UTC\ntimeMax: end of IST day in UTC\nResponse Handling\nThe MCP tool will return event data.\nConvert each event’s start and end times from UTC → IST.\nFor each event, extract:\ntitle: event title\ndate: event date in IST (YYYY-MM-DD)\ntime: formatted time range in IST (e.g., “10:00 AM - 11:00 AM”)\nOutput Format\nIf events are found, return the result only in this JSON array format:\n[\n  {\n    \"title\": \"Orientation Call - Batch A\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"10:00 AM - 11:00 AM\"\n  },\n  {\n    \"title\": \"Orientation Call - Batch B\",\n    \"date\": \"2025-10-25\",\n    \"time\": \"12:30 PM - 1:30 PM\"\n  }\n]\nIf no events are found, return an empty array:\n[]\n:cog: Important Instruction\nReturn the final output strictly as a valid JSON array — no markdown, no text explanation, no extra wrapping object.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","openai_api_key":"process.env.OPENAI_API_KEY","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"useStoredCredential":false,"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"structured-output-parser-1770836012620","nodeType":"structured-output-parser","config":{"inputSource":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770835965761\")}}"}},{"id":"script-event-1771005380506","nodeType":"script-event","config":{"pageId":"page-17702812000504656","scriptId":"ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","elementId":"component-1771002248957-6083","eventType":"onLoad","scriptKey":"page-17702812000504656::component-1771002248957-6083::onLoad::ef7e1ec7-0f59-42b2-abbb-6e2ea412a884","scriptName":"Orientationcall","actionValue":"select","componentId":"component-1771002248957-6083","inputVariables":[{"name":"innerHTML","type":"string","source":"element","description":"Element property: innerHTML"}],"outputVariables":[{"name":"selectedCall","type":"object","source":"custom","description":"Output variable: selectedCall"},{"name":"action","type":"object","source":"custom","description":"Output variable: action"},{"name":"callCount","type":"object","source":"custom","description":"Output variable: callCount"},{"name":"getInputData('response')","type":"object","source":"custom","description":"Variable: getInputData('response')"},{"name":"status","type":"object","source":"custom","description":"Variable: status"},{"name":"'response'","type":"object","source":"custom","description":"Variable: 'response'"}],"inputVariableMappings":{"innerHTML":"{{dataFlow.getByNodeId(\"structured-output-parser-1770836012620\")}}"}}}];
...
const executeAllFlows = async (triggerData: any = {}, specificChainId: string | null = null): Promise<any> => {
  ...
  // Execute flow_page-load-1770835954478_1771079854765
  if (!specificChainId || specificChainId === 'flow_page-load-1770835954478_1771079854765') {
    
    // This is a page-load chain for page: /orientation-calls
    if (triggerData && (triggerData.trigger === 'page-load' || triggerData.trigger === 'page-load-retry')) {
      ...
      const normalizedConfigUrl = '/orientation-calls'.replace(/\/$/, '');
      const normalizedCurrentPath = currentPath.replace(/\/$/, '');
      
      // Skip if paths don't match
      if (normalizedConfigUrl !== normalizedCurrentPath) {
        results['flow_page-load-1770835954478_1771079854765'] = { 
          success: false, 
          skipped: true, 
          reason: 'Page URL mismatch', 
          chainId: 'flow_page-load-1770835954478_1771079854765',
          configuredUrl: '/orientation-calls',
          currentPath
        };
        return;
      }
      ...
      try {
        const result_flow_page_load_1770835954478_1771079854765 = await executeFlowChain_flow_page_load_1770835954478_1771079854765(triggerData);
        results['flow_page-load-1770835954478_1771079854765'] = result_flow_page_load_1770835954478_1771079854765;
        
        if (!result_flow_page_load_1770835954478_1771079854765.success) {
          console.error('❌ Chain flow_page-load-1770835954478_1771079854765 failed:', result_flow_page_load_1770835954478_1771079854765.errors);
        }
      } catch (error) {
        const errorMessage = error instanceof Error ? error.message : String(error) || 'Unknown error';
        console.error('💥 Error executing flow flow_page-load-1770835954478_1771079854765:', error);
        results['flow_page-load-1770835954478_1771079854765'] = { success: false, error: errorMessage, chainId: 'flow_page-load-1770835954478_1771079854765', results: {}, errors: [errorMessage] };
      }
    }
...
const getFlowChainInfo = (): any[] => {
  return [
  {
    "id": "flow_page-load-1770835954478_1771079854765",
    "nodeTypes": [
      "page-load",
      "openaiAgentSDKNode",
    ...
    "chainType": "linear",
    "startNode": {
      "id": "page-load-1770835954478",
      "nodeType": "page-load",
      "config": {
        "pageId": "page-17702812000504656",
        "pageUrl": "/orientation-calls",
        "loadType": "full"
      }
    },
    "endNode": {
      "id": "script-event-1771005380506",
      "nodeType": "script-event",
      "config": {
        "pageId": "page-17702812000504656",
        "scriptId": "ef7e1ec7-0f59-42b2-abbb-6e2ea412a884",
        "elementId": "component-1771002248957-6083",
        "eventType": "onLoad",
        "scriptKey": "page-17702812000504656::component-1771002248957-6083::onLoad::ef7e1ec7-0f59-42b2-abbb-6e2ea412a884",
        "scriptName": "Orientationcall",
        "actionValue": "select",
        ...
        "outputVariables": [
          {
            ...
            "type": "object",
            "source": "custom",
            "description": "Output variable: selectedCall"
          },
          {
            "name": "action",
            "type": "object",
          ...
          },
          {
            ...
            "type": "object",
            "source": "custom",
            "description": "Output variable: callCount"
          },
          {
    ...
    "nodes": [
      ...
      {
        "id": "openaiAgentSDKNode-1770835965761",
        "nodeType": "openaiAgentSDKNode",
        "config": {
          ...
          "mcp_servers": [
            {
              "id": "custom_mcp_1770835987812",
              "url": "https://newgooglecalendar-smu6q7.simplita.ai/mcp",
              "name": "calendar",
              "enabled": true,
      ...
      {
        "id": "structured-output-parser-1770836012620",
        "nodeType": "structured-output-parser",
        "config": {
          "inputSource": "{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770835965761\")}}"
        }
      },
      {
        "id": "script-event-1771005380506",
