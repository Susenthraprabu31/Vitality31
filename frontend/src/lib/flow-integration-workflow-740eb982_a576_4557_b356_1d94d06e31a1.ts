...
const executeFlowChain_flow_timer_1770029212572_1771079854915 = async (initialData: any = {}): Promise<FlowResult> => {
  ...
  flowResults._executionId = `flow_timer_1770029212572_1771079854915_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
  ...
  //  flowResults.stepCounter = 0; // Initialize step counter for sequential step tracking
    ...
    flowResults.originalChainData = {"id":"flow_timer-1770029212572_1771079854915","nodes":[{"id":"timer-1770029212572","nodeType":"timer","config":{"repeat":true,"endTime":"23:59","interval":1000,"timezone":"UTC","startTime":"00:00","timerType":"interval"}},{"id":"openaiAgentSDKNode-1770029220303","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4.1-2025-04-14","tools":[],"userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770029299551","url":"https://newgooglecalendar-czvc54.simplita.ai","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","enableMemory":false,"handoff_mode":"transfer_control","instructions":"You are a helpful AI assistant.\n\nYour task:  \nEvery day at 9:00 AM IST, this automation fetches the list of today’s orientation calls from Google Calendar and sends it to Telegram.\n\nIMPORTANT — TIMEZONE FIX:\n• The Scheduler node already runs in IST.  \n• Therefore, the timestamp you receive from the Scheduler is **already IST**, NOT UTC.  \n• DO NOT treat the timestamp as UTC.  \n• DO NOT convert the scheduler timestamp.  \n• Instead, extract the IST date directly from it.\n\nExample scheduler timestamp (already IST):  \n2025-10-24T09:00:00+05:30\n\nYour job:\n1. Read the incoming IST timestamp from the Scheduler.\n2. Extract the date in IST (YYYY-MM-DD).\n3. Create the start & end of that IST date:\n   • 00:00:00 IST  \n   • 23:59:59 IST  \n\n4. Convert these two moments to UTC because Google Calendar API requires UTC.\n   Example:\n       IST 00:00:00 → UTC previous day 18:30:00Z  \n       IST 23:59:59 → UTC same day 18:29:59Z\n\n5. Use these converted values when calling the Google Calendar MCP tool:\n   timeMin = start of IST day converted to UTC  \n   timeMax = end of IST day converted to UTC  \n\nCalendar MCP configuration (already connected):\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\n\nAfter retrieving events:\n• Convert each event's start & end from UTC → IST\n• Format the output:\n\nIf events exist:\nToday's Orientation Calls:\n[Event Title] — [Start Time IST] to [End Time IST]\n\nIf no events:\nNo orientation calls are scheduled for today.\n\nCRITICAL RULE:\nDo NOT treat the scheduler timestamp as UTC.\nDo NOT apply double conversion.\nThe scheduler already uses IST.\nYour only conversion happens when preparing timeMin and timeMax for Google Calendar.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"telegram-send-message-1770029314521","nodeType":"Telegram Send Message","config":{"fields":[{"id":"bot_token","name":"Bot Token"},{"id":"chat_id","name":"Chat ID"},{"id":"text","name":"Message Text"},{"id":"parse_mode","name":"Parse Mode"},{"id":"media_type","name":"Media Type"},{"id":"media_url","name":"Media URL"},{"id":"media_caption","name":"Media Caption"}],"inputs":{"Chat ID":"static:1311299730","Bot Token":"static:","Media URL":"static:","Media Type":"static:none","Parse Mode":"static:HTML","Message Text":"static:{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","Media Caption":"static:"},"botToken":"","mediaUrl":"","mediaType":"none","parseMode":"HTML","sendMedia":false,"messageText":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","credentialId":"99bc673e-a01f-4d8d-9922-35efd8378449","mediaCaption":"","credentialName":"Gopinath_Telegramsend","selectedMethod":"telegram_send_message"}}],"edges":[{"source":"timer-1770029212572","target":"openaiAgentSDKNode-1770029220303"},{"source":"openaiAgentSDKNode-1770029220303","target":"telegram-send-message-1770029314521"}],"chainType":"linear","dataFlow":[],"startNode":{"id":"timer-1770029212572","nodeType":"timer","config":{"repeat":true,"endTime":"23:59","interval":1000,"timezone":"UTC","startTime":"00:00","timerType":"interval"}},"endNode":{"id":"telegram-send-message-1770029314521","nodeType":"Telegram Send Message","config":{"fields":[{"id":"bot_token","name":"Bot Token"},{"id":"chat_id","name":"Chat ID"},{"id":"text","name":"Message Text"},{"id":"parse_mode","name":"Parse Mode"},{"id":"media_type","name":"Media Type"},{"id":"media_url","name":"Media URL"},{"id":"media_caption","name":"Media Caption"}],"inputs":{"Chat ID":"static:1311299730","Bot Token":"static:","Media URL":"static:","Media Type":"static:none","Parse Mode":"static:HTML","Message Text":"static:{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","Media Caption":"static:"},"botToken":"","mediaUrl":"","mediaType":"none","parseMode":"HTML","sendMedia":false,"messageText":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","credentialId":"99bc673e-a01f-4d8d-9922-35efd8378449","mediaCaption":"","credentialName":"Gopinath_Telegramsend","selectedMethod":"telegram_send_message"}}};
    ...
    if (typeof window !== 'undefined') {
      ...
      const sanitizedNodes = [{"id":"timer-1770029212572","nodeType":"timer","config":{"repeat":true,"endTime":"23:59","interval":1000,"timezone":"UTC","startTime":"00:00","timerType":"interval"}},{"id":"openaiAgentSDKNode-1770029220303","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4.1-2025-04-14","tools":[],"userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770029299551","url":"https://newgooglecalendar-czvc54.simplita.ai","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","enableMemory":false,"handoff_mode":"transfer_control","instructions":"You are a helpful AI assistant.\n\nYour task:  \nEvery day at 9:00 AM IST, this automation fetches the list of today’s orientation calls from Google Calendar and sends it to Telegram.\n\nIMPORTANT — TIMEZONE FIX:\n• The Scheduler node already runs in IST.  \n• Therefore, the timestamp you receive from the Scheduler is **already IST**, NOT UTC.  \n• DO NOT treat the timestamp as UTC.  \n• DO NOT convert the scheduler timestamp.  \n• Instead, extract the IST date directly from it.\n\nExample scheduler timestamp (already IST):  \n2025-10-24T09:00:00+05:30\n\nYour job:\n1. Read the incoming IST timestamp from the Scheduler.\n2. Extract the date in IST (YYYY-MM-DD).\n3. Create the start & end of that IST date:\n   • 00:00:00 IST  \n   • 23:59:59 IST  \n\n4. Convert these two moments to UTC because Google Calendar API requires UTC.\n   Example:\n       IST 00:00:00 → UTC previous day 18:30:00Z  \n       IST 23:59:59 → UTC same day 18:29:59Z\n\n5. Use these converted values when calling the Google Calendar MCP tool:\n   timeMin = start of IST day converted to UTC  \n   timeMax = end of IST day converted to UTC  \n\nCalendar MCP configuration (already connected):\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\n\nAfter retrieving events:\n• Convert each event's start & end from UTC → IST\n• Format the output:\n\nIf events exist:\nToday's Orientation Calls:\n[Event Title] — [Start Time IST] to [End Time IST]\n\nIf no events:\nNo orientation calls are scheduled for today.\n\nCRITICAL RULE:\nDo NOT treat the scheduler timestamp as UTC.\nDo NOT apply double conversion.\nThe scheduler already uses IST.\nYour only conversion happens when preparing timeMin and timeMax for Google Calendar.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"telegram-send-message-1770029314521","nodeType":"Telegram Send Message","config":{"fields":[{"id":"bot_token","name":"Bot Token"},{"id":"chat_id","name":"Chat ID"},{"id":"text","name":"Message Text"},{"id":"parse_mode","name":"Parse Mode"},{"id":"media_type","name":"Media Type"},{"id":"media_url","name":"Media URL"},{"id":"media_caption","name":"Media Caption"}],"inputs":{"Chat ID":"static:1311299730","Bot Token":"static:","Media URL":"static:","Media Type":"static:none","Parse Mode":"static:HTML","Message Text":"static:{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","Media Caption":"static:"},"botToken":"","mediaUrl":"","mediaType":"none","parseMode":"HTML","sendMedia":false,"messageText":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","credentialId":"99bc673e-a01f-4d8d-9922-35efd8378449","mediaCaption":"","credentialName":"Gopinath_Telegramsend","selectedMethod":"telegram_send_message"}}];
      
      (window as any).__currentWorkflowNodes = sanitizedNodes;
      (window as any).__flowChainMetadata = {
        chainId: 'flow_timer-1770029212572_1771079854915',
    ...
    step1Result = {
      status: 'scheduled',
      mode: 'daily',
      nodeId: 'timer-1770029212572',
      scheduledTime: '09:00',
      timestamp: new Date().toISOString()
    };
    
    // Timer just sets up the schedule - actual execution will be handled by timer initialization
    console.log('⏰ Daily timer configured for 09:00 - execution will be handled by timer initialization');
    console.log('✅ Daily scheduler configured:', step1Result);
    
      
      
    // Store result in enhanced data flow system
    flowResults.nodeResults['timer-1770029212572'] = {
      nodeId: 'timer-1770029212572',
      nodeType: 'timer',
      stepNumber: 1,
      displayName: 'timerResult_timer_1770029212572',
      data: step1Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    if (!flowResults['timerResult_timer_1770029212572'] || typeof flowResults['timerResult_timer_1770029212572'] === 'undefined') {
      flowResults['timerResult_timer_1770029212572'] = step1Result;
    }
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.__executedNodes && window.__executedNodes.has('openaiAgentSDKNode-1770029220303')) {
        console.log('⏭Skipping node (already executed via handoff):', 'openaiAgentSDKNode-1770029220303');
        
        // Get the result from dataFlow if available
        const existingResult = dataFlow.getByNodeId('openaiAgentSDKNode-1770029220303');
        if (existingResult) {
        ...
        if (typeof window !== 'undefined' && window.__executedNodes) {
          window.__executedNodes.delete('openaiAgentSDKNode-1770029220303');
        }
      } else {
      let aiInput = '';
      ...
      if (!aiInput || aiInput.trim() === '') {
        ...
        if (false && 'simple' !== 'none' && typeof window !== 'undefined') {
          try {
            const agentId = 'agent-1771079854917';
            const userId = 'user-1771079854917';
...
Do NOT apply double conversion.
The scheduler already uses IST.
Your only conversion happens when preparing timeMin and timeMax for Google Calendar.`,
          temperature: 0.7,
          max_tokens: 1000,
          ...
          mcp_servers: [{"id":"custom_mcp_1770029299551","url":"https://newgooglecalendar-czvc54.simplita.ai","name":"calendar","enabled":true,"description":"Custom MCP Server"}],
      ...
      if (false && !result.handoff && typeof window !== 'undefined') {
        try {
          ...
          const outgoingEdges = workflowEdges.filter((e: any) => e.source === 'openaiAgentSDKNode-1770029220303');
      ...
      if (false && 'simple' !== 'none' && typeof window !== 'undefined') {
        try {
          const agentId = 'agent-1771079854917';
          const userId = 'user-1771079854917';
          const sessionId = 'session-1771079854917';
          const memoryStorageType = 'simple';
      ...
      flowResults.nodeResults['openaiAgentSDKNode-1770029220303'] = {
        nodeId: 'openaiAgentSDKNode-1770029220303',
      ...
      flowErrors.push('OpenAI Agent SDK error in node ' + "openaiAgentSDKNode-1770029220303" + ': ' + (error instanceof Error ? error.message : String(error)));
    }
    ...
    flowResults.nodeResults['openaiAgentSDKNode-1770029220303'] = {
      ...
      nodeType: 'openaiAgentSDKNode',
      stepNumber: 2,
      displayName: 'openaiSDKResult_openaiAgentSDKNode_1770029220303',
      data: step2Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    // Store in specialized collection using dynamic variable name
    flowResults.aiResponses['openaiSDKResult_openaiAgentSDKNode_1770029220303'] = step2Result;
    
    // Store at top-level for direct access (CRITICAL for HTTP nodes)
    // CRITICAL FIX: Don't overwrite if the processor already set a formatted result
    // This is especially important for Bolna AI which stores formattedResult before polling
    if (!flowResults['openaiSDKResult_openaiAgentSDKNode_1770029220303'] || typeof flowResults['openaiSDKResult_openaiAgentSDKNode_1770029220303'] === 'undefined') {
      flowResults['openaiSDKResult_openaiAgentSDKNode_1770029220303'] = step2Result;
    }
    ...
    let processedInput_telegram_send_message_1770029314521 = currentResult;
    ...
    if (typeof processedInput_telegram_send_message_1770029314521 === 'string' && processedInput_telegram_send_message_1770029314521.includes('dataFlow.')) {
      try {
        ...
        if (typeof dataFlow !== 'undefined') {
          ...
          if (processedInput_telegram_send_message_1770029314521.includes('{{dataFlow.getByNodeId(') && processedInput_telegram_send_message_1770029314521.includes('}}')) {
...
const multiDataFlowRegex = new RegExp(openBrace + functionCall + propertyAccess + closeBrace, 'g');
            ...
            let processedVariable = processedInput_telegram_send_message_1770029314521;
            let matchCount = 0;
            ...
            if (matchCount > 0) {
              processedInput_telegram_send_message_1770029314521 = processedVariable;
            }
          }
          
          // PRIORITY 2: Handle legacy single dataFlow.getByNodeId() without braces (backwards compatibility)
          else if (processedInput_telegram_send_message_1770029314521.includes('dataFlow.getByNodeId(') && !processedInput_telegram_send_message_1770029314521.includes('{{') && !processedInput_telegram_send_message_1770029314521.includes('}}')) {
            // Extract node ID and property access from pattern: dataFlow.getByNodeId('nodeId').PropertyName
            const legacyNodeIdMatch = processedInput_telegram_send_message_1770029314521.match(/dataFlow\.getByNodeId\(['"]([^'"]+)['"]\)(?:\.([a-zA-Z_$][a-zA-Z0-9_$]*))?/);
            if (legacyNodeIdMatch) {
              ...
              if (result !== undefined && result !== null) {
                ...
                if (propertyName) {
                  // Try direct property access first (most common for form fields)
                  if (typeof result === 'object' && result[propertyName] !== undefined) {
                    processedInput_telegram_send_message_1770029314521 = String(result[propertyName]);
                  }
                  // Try in formData
                  else if (result.formData && result.formData[propertyName] !== undefined) {
                    processedInput_telegram_send_message_1770029314521 = String(result.formData[propertyName]);
                  }
                  // Try in inputData
                  else if (result.inputData && result.inputData[propertyName] !== undefined) {
                    processedInput_telegram_send_message_1770029314521 = String(result.inputData[propertyName]);
                  }
                  // Try in data
                  else if (result.data && result.data[propertyName] !== undefined) {
                    processedInput_telegram_send_message_1770029314521 = String(result.data[propertyName]);
                  }
                  // Try case-insensitive property access for form fields
                  else if (typeof result === 'object') {
                    const resultKeys = Object.keys(result);
                    const matchingKey = resultKeys.find(key => key.toLowerCase() === propertyName.toLowerCase());
                    if (matchingKey && result[matchingKey] !== undefined) {
                      processedInput_telegram_send_message_1770029314521 = String(result[matchingKey]);
                    } else {
                      console.warn(`⚠️ Legacy: Property '${propertyName}' not found in result object. Available keys:`, resultKeys);
                      processedInput_telegram_send_message_1770029314521 = '[property not found: ' + propertyName + ']';
                    }
                  } else {
                    console.warn(`⚠️ Legacy: Cannot access property '${propertyName}' on non-object result`);
                    processedInput_telegram_send_message_1770029314521 = '[invalid property access]';
                  }
                } else {
                  // No property specified - use auto-extraction
                  if (typeof result === 'object') {
                    processedInput_telegram_send_message_1770029314521 = result.currentValue || result.value || result.data || String(result);
                  } else {
                    processedInput_telegram_send_message_1770029314521 = String(result);
                  }
                }
              } else {
                ...
                try {
                  if (typeof batchResult !== 'undefined' && batchResult !== null) {
                    ...
                    if (fallbackValue !== undefined && fallbackValue !== null) {
                      processedInput_telegram_send_message_1770029314521 = String(fallbackValue);
                    } else {
                      processedInput_telegram_send_message_1770029314521 = '[data not available]';
                    }
                  } else {
                    processedInput_telegram_send_message_1770029314521 = '[data not available]';
                  }
          ...
          } else if (processedInput_telegram_send_message_1770029314521.includes('dataFlow.current()')) {
            ...
            if (result !== undefined && result !== null) {
              ...
              processedInput_telegram_send_message_1770029314521 = '[current data not available]';
            }
          } else if (processedInput_telegram_send_message_1770029314521.includes('dataFlow.previous()')) {
            ...
            if (result !== undefined && result !== null) {
              ...
              processedInput_telegram_send_message_1770029314521 = '[previous data not available]';
            }
          } else if (processedInput_telegram_send_message_1770029314521.includes('dataFlow.get(')) {
            // Extract variable name from pattern: dataFlow.get('varName')
            const varNameMatch = processedInput_telegram_send_message_1770029314521.match(/dataFlow\.get\(['"]([^'"]+)['"]\)/);
            if (varNameMatch) {
              ...
              if (result !== undefined && result !== null) {
                ...
                processedInput_telegram_send_message_1770029314521 = '[variable not available]';
              }
            }
          }
        } else {
          console.warn('⚠️ dataFlow not available in scope');
          processedInput_telegram_send_message_1770029314521 = '[dataFlow not available]';
        }
      } catch (error) {
        console.error('❌ Error evaluating dataFlow expression:', error);
        processedInput_telegram_send_message_1770029314521 = '[dataFlow evaluation error]';
      }
    }
    ...
    try {
      ...
      const processTemplate = (template: string): any => {
        ...
        try {
          ...
          if (typeof processedInput_telegram_send_message_1770029314521 !== 'undefined' && processedInput_telegram_send_message_1770029314521 !== null) {
            templateContext.inputData = processedInput_telegram_send_message_1770029314521;
            templateContext.input = processedInput_telegram_send_message_1770029314521;
            // If inputData is an object, spread its properties
            if (typeof processedInput_telegram_send_message_1770029314521 === 'object' && !Array.isArray(processedInput_telegram_send_message_1770029314521)) {
              Object.assign(templateContext, processedInput_telegram_send_message_1770029314521);
            }
          }
      ...
      let chatId = "1311299730";
      
    let telegramMessage: string = "{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}";
    const configMessageFallback = "{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}";
      ...
      const getTemplateContext = () => {
        const baseContext = {
          ...flowResults,
          dataFlow,
          currentResult: processedInput_telegram_send_message_1770029314521,
          previousResult: flowResults.previousResult,
          inputData: processedInput_telegram_send_message_1770029314521?.inputData || {},
          formResult: processedInput_telegram_send_message_1770029314521?.formResult || {},
          apiResult: processedInput_telegram_send_message_1770029314521?.apiResult || {}
        };
        ...
        if (processedInput_telegram_send_message_1770029314521?.apiResult) {
          const apiRes = processedInput_telegram_send_message_1770029314521.apiResult;
  ...
  try {
    ...
    return '';
      ...
      step3Result = {
        ...processedInput_telegram_send_message_1770029314521,
        telegramResult: {
          success: true,
          chatId: chatId,
        ...
        nodeId: 'telegram-send-message-1770029314521'
      };
      ...
      const errorMessage = error instanceof Error ? error.message : String(error);
      flowErrors.push('Telegram error in node [telegram-send-message-1770029314521]: ' + errorMessage);
    ...
    // Store result in enhanced data flow system
    flowResults.nodeResults['telegram-send-message-1770029314521'] = {
      nodeId: 'telegram-send-message-1770029314521',
      nodeType: 'Telegram Send Message',
      stepNumber: 3,
      displayName: 'telegramSendResult_telegram_send_message_1770029314521',
      data: step3Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    // CRITICAL FIX: Don't overwrite if the processor already set a formatted result
    // This is especially important for Bolna AI which stores formattedResult before polling
    if (!flowResults['telegramSendResult_telegram_send_message_1770029314521'] || typeof flowResults['telegramSendResult_telegram_send_message_1770029314521'] === 'undefined') {
      flowResults['telegramSendResult_telegram_send_message_1770029314521'] = step3Result;
    }
    ...
    if (typeof window !== 'undefined') {
      ...
      if ('flow_timer-1770029212572_1771079854915'.includes('button')) {
        ...
        buttonNodes.forEach((buttonNode: any) => {
          ...
          if (buttonNode.elementId) {
            (window as any).buttonChainRegistry[buttonNode.elementId] = 'flow_timer-1770029212572_1771079854915';
            console.log(`🔗 Registered button chain: ${buttonNode.elementId} → flow_timer-1770029212572_1771079854915`);
          }
        });
      }
      ...
      (window as any).dispatchEvent(new CustomEvent('workflowCompleted', { 
        detail: { flowResults, chainId: 'flow_timer-1770029212572_1771079854915' } 
      }));
...
console.log('⏰ Initializing timers for chain: flow_timer-1770029212572_1771079854915');

// Daily timer for node timer-1770029212572 at 09:00
const initializeTimer_timer_1770029212572 = () => {
  const schedule_timer_1770029212572 = () => {
    const now = new Date();
    ...
    console.log('⏰ Timer timer-1770029212572: Next execution scheduled for', scheduledTime.toLocaleString());
    console.log('⏰ Timer timer-1770029212572: Time until execution:', Math.round(timeUntilExecution / 1000 / 60), 'minutes');
    
    setTimeout(async () => {
      try {
        console.log('🔥 Timer timer-1770029212572: Executing scheduled flow at', new Date().toLocaleString());
        
        // Execute the flow chain
        if (typeof executeFlowChain_flow_timer_1770029212572_1771079854915 === 'function') {
          const result = await executeFlowChain_flow_timer_1770029212572_1771079854915({
            triggeredBy: 'timer',
            timerId: 'timer-1770029212572',
            scheduledTime: '09:00',
            executionTime: new Date().toISOString()
          });
          
          console.log('✅ Timer timer-1770029212572: Flow execution completed:', result);
        } else {
          console.error('❌ Timer timer-1770029212572: Flow function not available');
        }
        
        // Schedule for next day/week
        schedule_timer_1770029212572();
        
      } catch (error) {
        console.error('❌ Timer timer-1770029212572: Execution error:', error);
  ...
  if (typeof window !== 'undefined') {
    (window as any).triggerTimer_timer_1770029212572 = async () => {
      if (typeof executeFlowChain_flow_timer_1770029212572_1771079854915 === 'function') {
        return await executeFlowChain_flow_timer_1770029212572_1771079854915({
          triggeredBy: 'manual',
          timerId: 'timer-1770029212572',
          manualTrigger: true,
          executionTime: new Date().toISOString()
...
initializeTimer_timer_1770029212572();
...
if (workflowRegistry && workflowRegistry.allNodes) {
  const workflowNodes = [{"id":"timer-1770029212572","nodeType":"timer","config":{"repeat":true,"endTime":"23:59","interval":1000,"timezone":"UTC","startTime":"00:00","timerType":"interval"}},{"id":"openaiAgentSDKNode-1770029220303","nodeType":"openaiAgentSDKNode","config":{"type":"openaiAgentSDKNode","label":"OpenAI Agent","model":"gpt-4.1-2025-04-14","tools":[],"apiKey":"","userId":"","agentId":"","nodeType":"openaiAgentSDK","noteText":"","sessionId":"","isAgentSDK":true,"max_tokens":1000,"memoryType":"simple","description":"OpenAI Agent application","mcp_servers":[{"id":"custom_mcp_1770029299551","url":"https://newgooglecalendar-czvc54.simplita.ai","name":"calendar","enabled":true,"description":"Custom MCP Server"}],"querySource":"","temperature":0.7,"user_prompt":"","agentSDKType":"orchestrator","credentialId":"","enableMemory":false,"handoff_mode":"transfer_control","instructions":"You are a helpful AI assistant.\n\nYour task:  \nEvery day at 9:00 AM IST, this automation fetches the list of today’s orientation calls from Google Calendar and sends it to Telegram.\n\nIMPORTANT — TIMEZONE FIX:\n• The Scheduler node already runs in IST.  \n• Therefore, the timestamp you receive from the Scheduler is **already IST**, NOT UTC.  \n• DO NOT treat the timestamp as UTC.  \n• DO NOT convert the scheduler timestamp.  \n• Instead, extract the IST date directly from it.\n\nExample scheduler timestamp (already IST):  \n2025-10-24T09:00:00+05:30\n\nYour job:\n1. Read the incoming IST timestamp from the Scheduler.\n2. Extract the date in IST (YYYY-MM-DD).\n3. Create the start & end of that IST date:\n   • 00:00:00 IST  \n   • 23:59:59 IST  \n\n4. Convert these two moments to UTC because Google Calendar API requires UTC.\n   Example:\n       IST 00:00:00 → UTC previous day 18:30:00Z  \n       IST 23:59:59 → UTC same day 18:29:59Z\n\n5. Use these converted values when calling the Google Calendar MCP tool:\n   timeMin = start of IST day converted to UTC  \n   timeMax = end of IST day converted to UTC  \n\nCalendar MCP configuration (already connected):\ncalendar_id: c51c958ccfdffb580ee5ad1e69dbab503e6331e53459e60187faa2626f0439f4@group.calendar.google.com\nsingleEvents: true\norderBy: startTime\nmaxResults: 20\n\nAfter retrieving events:\n• Convert each event's start & end from UTC → IST\n• Format the output:\n\nIf events exist:\nToday's Orientation Calls:\n[Event Title] — [Start Time IST] to [End Time IST]\n\nIf no events:\nNo orientation calls are scheduled for today.\n\nCRITICAL RULE:\nDo NOT treat the scheduler timestamp as UTC.\nDo NOT apply double conversion.\nThe scheduler already uses IST.\nYour only conversion happens when preparing timeMin and timeMax for Google Calendar.","tool_configs":{},"queryVariable":"","tool_settings":{"tool_timeout_ms":300,"error_handling_mode":"graceful","enable_parallel_execution":false,"max_tool_calls_per_request":5},"variableInput":"","openai_api_key":"process.env.OPENAI_API_KEY","resultVariable":"sdkResult","selected_tools":[],"handoff_enabled":false,"handoff_targets":[],"memoryTableName":"agent_interactions","selectedDataSources":[],"useStoredCredential":false,"auto_handoff_enabled":false,"isAgentSDKOrchestrator":false}},{"id":"telegram-send-message-1770029314521","nodeType":"Telegram Send Message","config":{"fields":[{"id":"bot_token","name":"Bot Token"},{"id":"chat_id","name":"Chat ID"},{"id":"text","name":"Message Text"},{"id":"parse_mode","name":"Parse Mode"},{"id":"media_type","name":"Media Type"},{"id":"media_url","name":"Media URL"},{"id":"media_caption","name":"Media Caption"}],"inputs":{"Chat ID":"static:1311299730","Bot Token":"static:","Media URL":"static:","Media Type":"static:none","Parse Mode":"static:HTML","Message Text":"static:{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","Media Caption":"static:"},"botToken":"","mediaUrl":"","mediaType":"none","parseMode":"HTML","sendMedia":false,"messageText":"{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}","credentialId":"99bc673e-a01f-4d8d-9922-35efd8378449","mediaCaption":"","credentialName":"Gopinath_Telegramsend","selectedMethod":"telegram_send_message"}}];
...
const executeAllFlows = async (triggerData: any = {}, specificChainId: string | null = null): Promise<any> => {
  ...
  // Execute flow_timer-1770029212572_1771079854915
  if (!specificChainId || specificChainId === 'flow_timer-1770029212572_1771079854915') {
    ...
    if (isButtonOrFormChain && isPageLoadTrigger && !specificChainId) {
      results['flow_timer_1770029212572_1771079854915'] = { 
        success: false, 
        skipped: true, 
        reason: 'Button/Form workflow should not run on page load',
        chainId: 'flow_timer_1770029212572_1771079854915',
      ...
      try {
        const result_flow_timer_1770029212572_1771079854915 = await executeFlowChain_flow_timer_1770029212572_1771079854915(triggerData);
        results['flow_timer_1770029212572_1771079854915'] = result_flow_timer_1770029212572_1771079854915;
        
        if (!result_flow_timer_1770029212572_1771079854915.success) {
          if (DEBUG_FLOW_SYSTEM) {
            console.error('❌ Chain flow_timer_1770029212572_1771079854915 failed:', result_flow_timer_1770029212572_1771079854915.errors);
          }
        }
      } catch (error) {
        const errorMessage = error instanceof Error ? error.message : String(error) || 'Unknown error';
        if (DEBUG_FLOW_SYSTEM) {
          console.error('💥 Error executing flow flow_timer_1770029212572_1771079854915:', error);
        }
        results['flow_timer_1770029212572_1771079854915'] = { success: false, error: errorMessage, chainId: 'flow_timer_1770029212572_1771079854915', results: {}, errors: [errorMessage] };
      }
    }
...
const getFlowChainInfo = (): any[] => {
  return [
  {
    "id": "flow_timer-1770029212572_1771079854915",
    "nodeTypes": [
      "timer",
      "openaiAgentSDKNode",
    ...
    "endNode": {
      "id": "telegram-send-message-1770029314521",
      "nodeType": "Telegram Send Message",
      "config": {
        "fields": [
          {
        ...
        "inputs": {
          "Chat ID": "static:1311299730",
          "Bot Token": "static:",
          "Media URL": "static:",
          "Media Type": "static:none",
          "Parse Mode": "static:HTML",
          "Message Text": "static:{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}",
        ...
        "parseMode": "HTML",
        "sendMedia": false,
        "messageText": "{{dataFlow.getByNodeId(\"openaiAgentSDKNode-1770029220303\")}}",
    ...
    "nodes": [
      ...
      {
        "id": "openaiAgentSDKNode-1770029220303",
        "nodeType": "openaiAgentSDKNode",
        "config": {
          ...
          "mcp_servers": [
            {
              "id": "custom_mcp_1770029299551",
              "url": "https://newgooglecalendar-czvc54.simplita.ai",
              "name": "calendar",
              "enabled": true,
