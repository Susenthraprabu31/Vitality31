...
const executeFlowChain_flow_page_load_1770834098560_1771079854789 = async (initialData: any = {}): Promise<FlowResult> => {
  ...
  flowResults._executionId = `flow_page_load_1770834098560_1771079854789_${Date.now()}_${Math.random().toString(36).substr(2, 9)}`;
  ...
  //  flowResults.stepCounter = 0; // Initialize step counter for sequential step tracking
    ...
    flowResults.originalChainData = {"id":"flow_page-load-1770834098560_1771079854789","nodes":[{"id":"page-load-1770834098560","nodeType":"page-load","config":{"pageId":"page-17702907459371426","pageUrl":"/chat-history","loadType":"full"}},{"id":"http-1770834118481","nodeType":"http","config":{"url":"https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU","method":"GET","headers":[],"timeout":30000,"bodyType":"empty","noteText":"","chunkSize":1024,"formFields":[],"retryDelay":1000,"bodyContent":"","contentType":"application/json","queryParams":[],"validateSSL":true,"parseResponse":true,"retryAttempts":3,"enableChunking":false,"resultVariable":"httpResult","enableStreaming":false,"followRedirects":true,"maxResponseSize":100}}],"edges":[{"source":"page-load-1770834098560","target":"http-1770834118481"}],"chainType":"linear","dataFlow":[],"startNode":{"id":"page-load-1770834098560","nodeType":"page-load","config":{"pageId":"page-17702907459371426","pageUrl":"/chat-history","loadType":"full"}},"endNode":{"id":"http-1770834118481","nodeType":"http","config":{"url":"https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU","method":"GET","headers":[],"timeout":30000,"bodyType":"empty","noteText":"","chunkSize":1024,"formFields":[],"retryDelay":1000,"bodyContent":"","contentType":"application/json","queryParams":[],"validateSSL":true,"parseResponse":true,"retryAttempts":3,"enableChunking":false,"resultVariable":"httpResult","enableStreaming":false,"followRedirects":true,"maxResponseSize":100}}};
    ...
    if (typeof window !== 'undefined') {
      ...
      const sanitizedNodes = [{"id":"page-load-1770834098560","nodeType":"page-load","config":{"pageId":"page-17702907459371426","pageUrl":"/chat-history","loadType":"full"}},{"id":"http-1770834118481","nodeType":"http","config":{"url":"https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU","method":"GET","headers":[],"timeout":30000,"bodyType":"empty","noteText":"","chunkSize":1024,"formFields":[],"retryDelay":1000,"bodyContent":"","contentType":"application/json","queryParams":[],"validateSSL":true,"parseResponse":true,"retryAttempts":3,"enableChunking":false,"resultVariable":"httpResult","enableStreaming":false,"followRedirects":true,"maxResponseSize":100}}];
      
      (window as any).__currentWorkflowNodes = sanitizedNodes;
      (window as any).__flowChainMetadata = {
        chainId: 'flow_page-load-1770834098560_1771079854789',
    ...
    const normalizedInput_page_load_1770834098560 = {};

    step1Result = {
      ...normalizedInput_page_load_1770834098560,
      pageId: 'current-page',
      nodeId: 'page-load-1770834098560',
      trigger: 'page-load',
      timestamp: new Date().toISOString(),
      config: {"pageId":"page-17702907459371426","pageUrl":"/chat-history","loadType":"full"}
    };
    ...
    flowResults.nodeResults['page-load-1770834098560'] = {
      nodeId: 'page-load-1770834098560',
      nodeType: 'page-load',
      stepNumber: 1,
      displayName: 'pageLoadResult_page_load_1770834098560',
      data: step1Result,
      timestamp: new Date().toISOString(),
      success: true
    };
    ...
    if (!flowResults['pageLoadResult_page_load_1770834098560'] || typeof flowResults['pageLoadResult_page_load_1770834098560'] === 'undefined') {
      flowResults['pageLoadResult_page_load_1770834098560'] = step1Result;
    }
    ...
    let fullUrl_http_1770834118481 = 'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU';
    let responseStatus_http_1770834118481: number = 0;
    let responseStatusText_http_1770834118481: string = '';
    let responseHeaders_http_1770834118481: Record<string, string> = {};
    let responseData_http_1770834118481: any = null;
    let lastError_http_1770834118481: any = null;
    
    try {
      if (!fullUrl_http_1770834118481 || fullUrl_http_1770834118481.trim() === '') {
      ...
      if (typeof window !== 'undefined') {
        window.dispatchEvent(new CustomEvent('apiLoadingStart', { 
          detail: { endpoint: 'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU', method: 'GET', nodeId: 'http-1770834118481' } 
        }));
      }
      ...
      fullUrl_http_1770834118481 = TemplateExpressionEngine.processTemplate(fullUrl_http_1770834118481, urlTemplateContext, {
        allowComplexExpressions: true,
        allowFunctions: true,
        securityLevel: 'moderate',
        returnType: 'string',
        fallbackValue: fullUrl_http_1770834118481
      });
      
      // Ensure URL has a protocol
      if (!fullUrl_http_1770834118481.startsWith('http://') && !fullUrl_http_1770834118481.startsWith('https://')) {
        const apiBaseUrl = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8000';
        fullUrl_http_1770834118481 = fullUrl_http_1770834118481.startsWith('/') ? `${apiBaseUrl}${fullUrl_http_1770834118481}` : `${apiBaseUrl}/${fullUrl_http_1770834118481}`;
      }
      ...
      while (attempt <= retryAttempts) {
        ...
        console.warn('🌐 Request timeout');
          ...
          response = await fetch(fullUrl_http_1770834118481, requestOptions);
          ...
          // Process response
          responseStatus_http_1770834118481 = response.status;
          responseStatusText_http_1770834118481 = response.statusText;
          responseHeaders_http_1770834118481 = {};
          response.headers.forEach((value, key) => {
            responseHeaders_http_1770834118481[key] = value;
          });
        ...
        console.info('🌐 Processing large response in chunks');
              ...
              if (contentType.includes('application/json')) {
                ...
                responseData_http_1770834118481 = JSON.parse(textResponse);
              } else {
                responseData_http_1770834118481 = await response.text();
              }
            } else {
              // Standard processing for smaller responses
              if (contentType.includes('application/json')) {
                responseData_http_1770834118481 = await response.json();
            ...
            if (contentType.includes('application/json') || responseText.trim().startsWith('{') || responseText.trim().startsWith('[')) {
              try {
                responseData_http_1770834118481 = JSON.parse(responseText);
                console.log('✅ Parsed HTTP response as JSON:', {
                  type: typeof responseData_http_1770834118481,
                  hasData: !!responseData_http_1770834118481?.data,
                  dataLength: Array.isArray(responseData_http_1770834118481?.data) ? responseData_http_1770834118481.data.length : 'not array'
                });
              } catch (parseError) {
                console.warn('⚠️ Failed to parse JSON response, using text:', parseError);
                responseData_http_1770834118481 = responseText;
              }
            } else {
              responseData_http_1770834118481 = responseText;
            }
          ...
          lastError_http_1770834118481 = error;
          attempt++;
      ...
      if (attempt > retryAttempts) {
        throw lastError_http_1770834118481 || new Error('HTTP request failed after all retry attempts');
      }
      
       // CRITICAL: Ensure responseData is parsed if it's still a string
      if (typeof responseData_http_1770834118481 === 'string') {
        try {
          const trimmed = responseData_http_1770834118481.trim();
          if (trimmed.startsWith('{') || trimmed.startsWith('[')) {
            responseData_http_1770834118481 = JSON.parse(responseData_http_1770834118481);
            console.log(`✅ Parsed httpResult from string to object`);
          }
        } catch (parseError) {
          console.warn('⚠️ Failed to parse responseData_http_1770834118481:', parseError);
        }
      }
      ...
      if (typeof window !== 'undefined') {
        window.dispatchEvent(new CustomEvent('apiLoadingEnd', { 
          detail: { 
            success: true,
            endpoint: 'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU', 
            method: 'GET', 
            nodeId: 'http-1770834118481',
            response: responseData_http_1770834118481
          } 
        }));
      }
      ...
      const isAuthEndpoint_http_1770834118481 = (fullUrl_http_1770834118481.toLowerCase().includes('/login') || 
                                              fullUrl_http_1770834118481.toLowerCase().includes('/signup') || 
                                              fullUrl_http_1770834118481.toLowerCase().includes('/sign-in') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/sign-up') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/register') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/auth/login') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/auth/signup') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/auth/register'));
      ...
      if (responseOk && isAuthEndpoint_http_1770834118481 && typeof window !== 'undefined') {
        try {
          // Extract user_id from login/signup response
          const userId = responseData_http_1770834118481?.user_id || 
                        responseData_http_1770834118481?.user?.id;
          ...
          if (userId) {
            ...
            console.warn('⚠️ Could not extract userId from auth response:', responseData_http_1770834118481);
          }
        } catch (cookieError) {
      ...
      if (!responseOk && isAuthEndpoint_http_1770834118481) {
        // Map authentication errors to user-friendly messages
        let authErrorMessage_http_1770834118481 = '';
        const lowerUrl_http_1770834118481 = fullUrl_http_1770834118481.toLowerCase();
        const isLogin_http_1770834118481 = lowerUrl_http_1770834118481.includes('/login') || lowerUrl_http_1770834118481.includes('/sign-in');
        const isSignup_http_1770834118481 = lowerUrl_http_1770834118481.includes('/signup') || lowerUrl_http_1770834118481.includes('/sign-up') || lowerUrl_http_1770834118481.includes('/register');
        
        // Extract error message from response data
        if (responseData_http_1770834118481) {
          if (typeof responseData_http_1770834118481 === 'string') {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481;
          } else if (responseData_http_1770834118481.detail) {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481.detail;
          } else if (responseData_http_1770834118481.message) {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481.message;
          } else if (responseData_http_1770834118481.error) {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481.error;
          }
        }
        
        const lowerError_http_1770834118481 = authErrorMessage_http_1770834118481.toLowerCase();
        
        // Login-specific error mapping
        if (isLogin_http_1770834118481) {
          if (responseStatus_http_1770834118481 === 401) {
            if (lowerError_http_1770834118481.includes('not registered') || lowerError_http_1770834118481.includes('not found') || lowerError_http_1770834118481.includes('does not exist')) {
              authErrorMessage_http_1770834118481 = 'Email is not registered, kindly register';
            } else {
              authErrorMessage_http_1770834118481 = 'Email or password is incorrect';
            }
          } else if (responseStatus_http_1770834118481 === 404) {
            authErrorMessage_http_1770834118481 = 'Email is not registered, kindly register';
          } else if (responseStatus_http_1770834118481 === 403) {
            authErrorMessage_http_1770834118481 = 'Account is inactive';
          } else if (!authErrorMessage_http_1770834118481) {
            authErrorMessage_http_1770834118481 = 'Authentication failed. Please check your credentials';
          }
        }
        
        // Signup-specific error mapping
        if (isSignup_http_1770834118481) {
          if (responseStatus_http_1770834118481 === 400 || responseStatus_http_1770834118481 === 409) {
            if (lowerError_http_1770834118481.includes('already registered') || lowerError_http_1770834118481.includes('already exists') || lowerError_http_1770834118481.includes('email already')) {
              authErrorMessage_http_1770834118481 = 'Email is already registered';
            } else if (lowerError_http_1770834118481.includes('password') && (lowerError_http_1770834118481.includes('match') || lowerError_http_1770834118481.includes('mismatch') || lowerError_http_1770834118481.includes('confirm'))) {
              authErrorMessage_http_1770834118481 = 'Password and confirm password do not match';
            } else if (lowerError_http_1770834118481.includes('password') && (lowerError_http_1770834118481.includes('short') || lowerError_http_1770834118481.includes('length') || lowerError_http_1770834118481.includes('minimum'))) {
              authErrorMessage_http_1770834118481 = 'Password is too short. Please use at least 8 characters';
            } else if (!authErrorMessage_http_1770834118481) {
              authErrorMessage_http_1770834118481 = 'Invalid request. Please check your input';
            }
          } else if (!authErrorMessage_http_1770834118481) {
            authErrorMessage_http_1770834118481 = 'An error occurred. Please try again';
          }
        }
        ...
        if (typeof window !== 'undefined') {
          ...
          const toast_http_1770834118481 = document.createElement('div');
          toast_http_1770834118481.className = 'fixed top-4 right-4 px-4 py-2 rounded-md text-white text-sm z-50 bg-red-500';
          toast_http_1770834118481.textContent = authErrorMessage_http_1770834118481 || 'Authentication error occurred';
          toast_http_1770834118481.style.cssText = `position: fixed; top: 20px; right: 20px; z-index: 10000; padding: 16px; border-radius: 6px; background-color: #ef4444; color: white; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); min-width: 300px;`;
          document.body.appendChild(toast_http_1770834118481);
          
          setTimeout(() => {
            toast_http_1770834118481.style.opacity = '0';
            toast_http_1770834118481.style.transition = 'opacity 0.5s ease';
            setTimeout(() => {
              if (toast_http_1770834118481.parentElement) {
                document.body.removeChild(toast_http_1770834118481);
              }
            }, 500);
          }, 5000);
        }
        ...
        if (flowResults) {
          ...
          flowResults.lastAuthError = authErrorMessage_http_1770834118481 || 'Authentication error occurred';
        } else {
      ...
      step2Result = {
        ...currentResult,
        httpResult: responseData_http_1770834118481,
        httpSuccess: responseOk,
        httpStatus: responseStatus_http_1770834118481,
        httpStatusText: responseStatusText_http_1770834118481,
        httpHeaders: responseHeaders_http_1770834118481,
        httpUrl: fullUrl_http_1770834118481,
        httpMethod: 'GET',
        timestamp: new Date().toISOString()
      };
      ...
      let extractedData_http_1770834118481 = responseData_http_1770834118481;
      
      if (responseData_http_1770834118481 && typeof responseData_http_1770834118481 === 'object' && !Array.isArray(responseData_http_1770834118481)) {
        // Pattern 1: { data: [...] } or { data: {...} }
        if (responseData_http_1770834118481.data !== undefined && responseData_http_1770834118481.data !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.data;
          console.log('✅ Extracted data from response.data field');
        }
        // Pattern 2: { result: [...] } or { result: {...} }
        else if (responseData_http_1770834118481.result !== undefined && responseData_http_1770834118481.result !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.result;
          console.log('✅ Extracted data from response.result field');
        }
        // Pattern 3: { items: [...] }
        else if (responseData_http_1770834118481.items !== undefined && responseData_http_1770834118481.items !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.items;
          console.log('✅ Extracted data from response.items field');
        }
        // Pattern 4: { results: [...] }
        else if (responseData_http_1770834118481.results !== undefined && responseData_http_1770834118481.results !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.results;
          console.log('✅ Extracted data from response.results field');
        }
        // Pattern 5: { records: [...] }
        else if (responseData_http_1770834118481.records !== undefined && responseData_http_1770834118481.records !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.records;
          console.log('✅ Extracted data from response.records field');
        }
        // Pattern 6: { rows: [...] }
        else if (responseData_http_1770834118481.rows !== undefined && responseData_http_1770834118481.rows !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.rows;
          console.log('✅ Extracted data from response.rows field');
        }
        // Pattern 7: { payload: [...] } or { payload: {...} }
        else if (responseData_http_1770834118481.payload !== undefined && responseData_http_1770834118481.payload !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.payload;
          console.log('✅ Extracted data from response.payload field');
        }
        // Pattern 8: { body: [...] } or { body: {...} }
        else if (responseData_http_1770834118481.body !== undefined && responseData_http_1770834118481.body !== null) {
          extractedData_http_1770834118481 = responseData_http_1770834118481.body;
          console.log('✅ Extracted data from response.body field');
        }
      }
      
      // Store both raw and extracted data
      flowResults.apiResponses["httpResult_raw"] = responseData_http_1770834118481;
      flowResults.apiResponses["httpResult"] = extractedData_http_1770834118481;
      
      flowResults.variables["httpResult_raw"] = responseData_http_1770834118481;
      flowResults.variables["httpResult"] = extractedData_http_1770834118481;
      
      flowResults.nodeResults["http-1770834118481"] = {
        data: extractedData_http_1770834118481,
        rawData: responseData_http_1770834118481,
        displayName: "httpResult",
        nodeType: "http",
        success: responseOk,
        status: responseStatus_http_1770834118481,
        stepNumber: (flowResults.stepCounter || 0) + 1
      };
      
      // Store at top-level for direct access (use extracted data)
      flowResults["httpResult"] = extractedData_http_1770834118481;
      flowResults["httpResult_raw"] = responseData_http_1770834118481;
      
      // Update result tracking (use extracted data)
      flowResults.previousResult = flowResults.currentResult;
      flowResults.currentResult = extractedData_http_1770834118481;
      ...
      // Check if this is an authentication endpoint and handle errors appropriately
      const isAuthEndpoint_http_1770834118481 = (fullUrl_http_1770834118481 && (fullUrl_http_1770834118481.toLowerCase().includes('/login') || 
                                              fullUrl_http_1770834118481.toLowerCase().includes('/signup') || 
                                              fullUrl_http_1770834118481.toLowerCase().includes('/sign-in') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/sign-up') ||
                                              fullUrl_http_1770834118481.toLowerCase().includes('/register') ||
                                              ...
                                              ('https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/login') || 
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/signup') || 
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/sign-in') ||
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/sign-up') ||
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/register') ||
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/auth/login') ||
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/auth/signup') ||
                                               'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU'.toLowerCase().includes('/auth/register'));
      
      if (isAuthEndpoint_http_1770834118481) {
        // For authentication endpoints, show user-friendly error message
        let authErrorMessage_http_1770834118481 = 'An error occurred. Please try again';
        
        // Try to extract error from response if available
        if (responseData_http_1770834118481 && typeof responseData_http_1770834118481 === 'object') {
          if (responseData_http_1770834118481.detail) {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481.detail;
          } else if (responseData_http_1770834118481.message) {
            authErrorMessage_http_1770834118481 = responseData_http_1770834118481.message;
          } else if (responseData_http_1770834118481.error) {
          ...
          authErrorMessage_http_1770834118481 = error.message;
        }
        ...
        if (typeof window !== 'undefined') {
          const toast_http_1770834118481 = document.createElement('div');
          toast_http_1770834118481.className = 'fixed top-4 right-4 px-4 py-2 rounded-md text-white text-sm z-50 bg-red-500';
          toast_http_1770834118481.textContent = authErrorMessage_http_1770834118481;
          toast_http_1770834118481.style.cssText = `position: fixed; top: 20px; right: 20px; z-index: 10000; padding: 16px; border-radius: 6px; background-color: #ef4444; color: white; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); min-width: 300px;`;
          document.body.appendChild(toast_http_1770834118481);
        ...
        if (flowResults) {
          flowResults.authError = true;
          flowResults.lastAuthError = authErrorMessage_http_1770834118481;
        } else {
          console.warn('⚠️ flowResults not available, cannot set authError flag');
        }
      }
      ...
      step2Result = {
        ...currentResult,
        httpResult: responseData_http_1770834118481 || null,
        httpError: error?.message || 'Unknown HTTP error',
        httpSuccess: false,
        httpStatus: responseStatus_http_1770834118481 || 0,
        httpStatusText: responseStatusText_http_1770834118481 || '',
        httpHeaders: responseHeaders_http_1770834118481 || {},
        httpUrl: fullUrl_http_1770834118481 || 'https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU',
        httpMethod: 'GET',
        timestamp: new Date().toISOString()
      };
      ...
      let extractedErrorData_http_1770834118481 = responseData_http_1770834118481 || null;
      if (responseData_http_1770834118481 && typeof responseData_http_1770834118481 === 'object' && !Array.isArray(responseData_http_1770834118481)) {
        if (responseData_http_1770834118481.data !== undefined) {
          extractedErrorData_http_1770834118481 = responseData_http_1770834118481.data;
        } else if (responseData_http_1770834118481.result !== undefined) {
          extractedErrorData_http_1770834118481 = responseData_http_1770834118481.result;
        }
      }
      
      flowResults.apiResponses["httpResult_raw"] = responseData_http_1770834118481 || null;
      flowResults.apiResponses["httpResult"] = extractedErrorData_http_1770834118481;
      
      flowResults.variables["httpResult_raw"] = responseData_http_1770834118481 || null;
      flowResults.variables["httpResult"] = extractedErrorData_http_1770834118481;
      
      flowResults.nodeResults["http-1770834118481"] = {
        data: extractedErrorData_http_1770834118481,
        rawData: responseData_http_1770834118481 || null,
        error: error?.message || 'Unknown HTTP error',
        displayName: "httpResult",
        nodeType: "http",
        success: false,
        status: responseStatus_http_1770834118481 || 0,
        statusText: responseStatusText_http_1770834118481 || '',
        stepNumber: (flowResults.stepCounter || 0) + 1
      };
      
      flowResults["httpResult"] = extractedErrorData_http_1770834118481;
      flowResults["httpResult_raw"] = responseData_http_1770834118481 || null;
    }
    ...
    if (typeof window !== 'undefined') {
      ...
      if ('flow_page-load-1770834098560_1771079854789'.includes('button')) {
        ...
        buttonNodes.forEach((buttonNode: any) => {
          ...
          if (buttonNode.elementId) {
            (window as any).buttonChainRegistry[buttonNode.elementId] = 'flow_page-load-1770834098560_1771079854789';
            console.log(`🔗 Registered button chain: ${buttonNode.elementId} → flow_page-load-1770834098560_1771079854789`);
          }
        });
      }
      ...
      (window as any).dispatchEvent(new CustomEvent('workflowCompleted', { 
        detail: { flowResults, chainId: 'flow_page-load-1770834098560_1771079854789' } 
      }));
...
if (workflowRegistry && workflowRegistry.allNodes) {
  const workflowNodes = [{"id":"page-load-1770834098560","nodeType":"page-load","config":{"pageId":"page-17702907459371426","pageUrl":"/chat-history","loadType":"full"}},{"id":"http-1770834118481","nodeType":"http","config":{"url":"https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU","method":"GET","headers":[],"timeout":30000,"bodyType":"empty","noteText":"","chunkSize":1024,"formFields":[],"retryDelay":1000,"bodyContent":"","contentType":"application/json","queryParams":[],"validateSSL":true,"parseResponse":true,"retryAttempts":3,"enableChunking":false,"resultVariable":"httpResult","enableStreaming":false,"followRedirects":true,"maxResponseSize":100}}];
...
const executeAllFlows = async (triggerData: any = {}, specificChainId: string | null = null): Promise<any> => {
  ...
  // Execute flow_page-load-1770834098560_1771079854789
  if (!specificChainId || specificChainId === 'flow_page-load-1770834098560_1771079854789') {
    
    // This is a page-load chain for page: /chat-history
    if (triggerData && (triggerData.trigger === 'page-load' || triggerData.trigger === 'page-load-retry')) {
      ...
      const normalizedConfigUrl = '/chat-history'.replace(/\/$/, '');
      const normalizedCurrentPath = currentPath.replace(/\/$/, '');
      
      // Skip if paths don't match
      if (normalizedConfigUrl !== normalizedCurrentPath) {
        results['flow_page-load-1770834098560_1771079854789'] = { 
          success: false, 
          skipped: true, 
          reason: 'Page URL mismatch', 
          chainId: 'flow_page-load-1770834098560_1771079854789',
          configuredUrl: '/chat-history',
          currentPath
        };
        return;
      }
      ...
      try {
        const result_flow_page_load_1770834098560_1771079854789 = await executeFlowChain_flow_page_load_1770834098560_1771079854789(triggerData);
        results['flow_page-load-1770834098560_1771079854789'] = result_flow_page_load_1770834098560_1771079854789;
        
        if (!result_flow_page_load_1770834098560_1771079854789.success) {
          console.error('❌ Chain flow_page-load-1770834098560_1771079854789 failed:', result_flow_page_load_1770834098560_1771079854789.errors);
        }
      } catch (error) {
        const errorMessage = error instanceof Error ? error.message : String(error) || 'Unknown error';
        console.error('💥 Error executing flow flow_page-load-1770834098560_1771079854789:', error);
        results['flow_page-load-1770834098560_1771079854789'] = { success: false, error: errorMessage, chainId: 'flow_page-load-1770834098560_1771079854789', results: {}, errors: [errorMessage] };
      }
    }
...
const getFlowChainInfo = (): any[] => {
  return [
  {
    "id": "flow_page-load-1770834098560_1771079854789",
    "nodeTypes": [
      "page-load",
      "http"
    ],
    ...
    "chainType": "linear",
    "startNode": {
      "id": "page-load-1770834098560",
      "nodeType": "page-load",
      "config": {
        "pageId": "page-17702907459371426",
        "pageUrl": "/chat-history",
        "loadType": "full"
      }
    },
    "endNode": {
      "id": "http-1770834118481",
      "nodeType": "http",
      "config": {
        "url": "https://loejhunuyscavxtsvnkl.supabase.co/rest/v1/crudsupabase?apikey=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxvZWpodW51eXNjYXZ4dHN2bmtsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NzY1NjUwNCwiZXhwIjoyMDczMjMyNTA0fQ.6ERQ8rwPpaQkAxp2mZ_S8TtCzZ65rznxVnXnZzkOfmU",
        "method": "GET",
        "headers": [],
        "timeout": 30000,
        "bodyType": "empty",
